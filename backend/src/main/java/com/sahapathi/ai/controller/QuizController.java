...
public class QuizController {
    ...
    public ResponseEntity<ApiResponse<QuizResponse>> publish(@PathVariable String id) {
    ...
    public ResponseEntity<ApiResponse<List<QuizAttemptResponse>>> getAttempts(@PathVariable String id) {
