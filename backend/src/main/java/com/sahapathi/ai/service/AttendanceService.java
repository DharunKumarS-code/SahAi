...
public class AttendanceService {
    ...
    @Transactional
    public List<AttendanceResponse> markAttendance(AttendanceRequest request, String teacherId) {
    ...
    public List<AttendanceResponse> getAttendanceByDate(String classroomId, LocalDate date) {
        return attendanceRepository.findByClassroomIdAndDate(classroomId, date)
                .stream().map(this::mapToResponse).collect(Collectors.toList());
    }

    public AttendanceStatsResponse getStudentStats(String studentId, String classroomId) {
    ...
    public List<AttendanceResponse> getMonthlyReport(String classroomId, int year, int month) {
