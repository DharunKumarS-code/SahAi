...
public class AIRecommendationService {
    ...
    @Transactional
    public List<AIRecommendationResponse> generateRecommendations(String classroomId) {
        ...
        for (var mapping : students) {
            ...
            // Determine type based on mock analysis
    ...
    public List<AIRecommendationResponse> getRecommendations(String classroomId) {
        return recommendationRepository.findByClassroomIdAndIsResolvedFalseOrderByCreatedAtDesc(classroomId)
                .stream().map(this::mapToResponse).collect(Collectors.toList());
    }

    @Transactional
    public void resolveRecommendation(String id) {
    ...
    private AIRecommendationResponse mapToResponse(AIRecommendation rec) {
        return AIRecommendationResponse.builder()
                ...
                .classroomId(rec.getClassroom().getId())
