...
public class LessonService {
    ...
    @Transactional
    public LessonResponse createLesson(LessonRequest request, String teacherId) {
    ...
    public List<LessonResponse> getLessonsByClassroom(String classroomId, boolean publishedOnly) {
