...
public class ClassroomService {
    ...
    @Transactional
    public ClassroomResponse createClassroom(ClassroomRequest request, String teacherId) {
    ...
    public ClassroomResponse getClassroom(String id) {
        Classroom classroom = classroomRepository.findById(id)
                .orElseThrow(() -> new ResourceNotFoundException("Classroom", "id", id));
        return mapToResponse(classroom);
    }

    public List<ClassroomResponse> getTeacherClassrooms(String teacherId) {
        return classroomRepository.findByTeacherIdAndIsActiveTrue(teacherId)
                .stream().map(this::mapToResponse).collect(Collectors.toList());
    }

    public List<ClassroomResponse> getStudentClassrooms(String studentId) {
    ...
    @Transactional
    public ClassroomResponse updateClassroom(String id, ClassroomRequest request, String teacherId) {
        Classroom classroom = classroomRepository.findById(id)
                .orElseThrow(() -> new ResourceNotFoundException("Classroom", "id", id));
    ...
    @Transactional
    public String joinClassroom(String inviteCode, String studentId) {
    ...
    public List<UserResponse> getClassroomStudents(String classroomId) {
