...
const mockChartData = [
  { day: 'Mon', participation: 85, attendance: 92 },
  { day: 'Tue', participation: 78, attendance: 88 },
  { day: 'Wed', participation: 92, attendance: 95 },
  { day: 'Thu', participation: 65, attendance: 82 },
  { day: 'Fri', participation: 88, attendance: 90 },
];
...
const TeacherDashboard = () => {
  ...
  const loadData = async () => {
    try {
      ...
      // Demo data
      setClassrooms([
        { id: 1, name: 'Science - Grade 8', subject: 'Science', grade: '8', studentCount: 35, lessonCount: 12, quizCount: 5, inviteCode: 'ABC123' },
        { id: 2, name: 'Mathematics - Grade 9', subject: 'Mathematics', grade: '9', studentCount: 28, lessonCount: 8, quizCount: 3, inviteCode: 'XYZ789' },
      ]);
    }

    setRecommendations([
      { id: 1, studentName: 'Priya Kumar', type: 'LOW_PARTICIPATION', message: 'Has not participated in the last 3 classes. Consider a check-in.', priority: 'HIGH' },
      { id: 2, studentName: 'Rahul Singh', type: 'ATTENDANCE_CONCERN', message: 'Attendance dropped to 60% this month.', priority: 'CRITICAL' },
      { id: 3, studentName: 'Ananya Sharma', type: 'IMPROVEMENT', message: 'Quiz scores improved by 25%. Positive reinforcement recommended.', priority: 'LOW' },
    ]);
    setLoading(false);
  };
        ...
        <Grid item xs={12} md={4}>
          <Card sx={{ borderRadius: '16px', p: 3, height: '100%' }}>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
              ...
              <Chip label="3 New" size="small" sx={{ bgcolor: 'rgba(139,92,246,0.15)', color: '#8B5CF6', fontWeight: 600 }} />
            </Box>
            <List sx={{ p: 0 }}>
